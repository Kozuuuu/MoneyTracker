...
public class CalculatorService {
    ...
    public BigDecimal calculateExtra(Calculator input) {
        ...
        BigDecimal additionalExpenses = input.getExpensesPerDay().multiply(BigDecimal.valueOf(daysUntilNextPayroll));
        
        // Calculate total expenses by adding monthly expenses
        BigDecimal totalExpenses = additionalExpenses.add(input.getMonthlyExpenses());
